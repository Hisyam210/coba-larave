...
<html lang="en">
  ...
  <body>
    ...
    <section
      id="home"
      class="bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-80 bg-gradient-to-tl from-white via-cyan-200 to-hijaumuda bg-contain md:bg-contain bg-no-repeat lg:bg-auto"
    >
      <div class="container">
        <div class="flex flex-wrap" data-aos="fade-up" data-aos-duration="700">
          <div class="w-full self-center px-4 lg:w-[45%]">
            <div class="mb-12 space-y-2 text-center font-poppins">
              <h1
                class="block w-max font-medium mx-auto px-3 py-1.5 border border-green-200 rounded-full bg-green-100 text-green-600"
              >
                Teachers
              </h1>
              <h2
                class="block w-max mx-auto px-5 py-1.5 border text-4xl lg:text-5xl  p-4 font-caveat border-green-200 rounded-full bg-green-100 text-green-600"
              >
                Guru & Staff 
              </h2>
              <h2
          ...
          <div class="w-full self-end lg:w-[55%]">
            <div class="relative mt-10">
              <lottie-player
                id="fifthLottie"
                src="https://assets9.lottiefiles.com/packages/lf20_gepgb44u.json"
                alt="Video looping teacher"
                >"></lottie-player
              >
            </div>
          </div>
    ...
    <div class="py-20 bg-gray-50">
      <div class="container mx-auto px-6 md:px-12 xl:px-32">
        <div class="mb-16 text-center w-full flex-wrap">
          <h2 class="text-center text-2xl text-gray-900 font-bold md:text-3xl">
            Kepala Sekolah
          </h2>
          <p class="text-black text-3xl font-bold">&</p>
          <h2 class="text-center text-2xl text-gray-900 font-bold md:text-3xl">
            Wakil Kepala Sekolah
          </h2>
        </div>
        <div class="grid gap-2 items-center md:grid-cols-1">
          <div class="space-y-4 mb-10 text-center">
            <img
              class="w-64 h-64 mx-auto object-cover rounded-xl md:w-48 md:h-64 lg:w-64 lg:h-80"
              src="{{ asset('storage/' . (empty($guru[0]['image'])?'avatar2.png': $guru[0]['image'] ) ) }}"
              alt="man"
              loading="lazy"
              width="1200"
              height="800"
            />
            <div>
              <h4 class="text-2xl">{{ (empty($guru[0]['name'])?'data belum diisi':$guru[0]['name']) }}</h4>
              <span class="block text-sm text-gray-500">{{ (empty($guru[0]['posisi'])?'data belum diisi':$guru[0]['posisi']) }}</span>
            </div>
          </div>
          <div class="space-y-4 text-center">
            <img
              class="w-64 h-64 mx-auto object-cover rounded-xl md:w-40 md:h-40 lg:w-64 lg:h-64"
              src="{{ asset('storage/' . (empty($guru[1]['image'])?'avatar2.png': $guru[1]['image'] ) ) }}"
              alt="woman"
              loading="lazy"
              width="640"
              height="805"
            />
            <div>
              <h3 class="text-2xl">{{ (empty($guru[1]['name'])?'data belum diisi':$guru[1]['name']) }}</h3>
              <span class="block text-sm text-gray-500"
                >{{ (empty($guru[1]['posisi'])?'data belum diisi':$guru[1]['posisi']) }}</span
              >
            </div>
          </div>
        </div>
        ...
        <div class="py-20 w-full">
          <div class="container mx-auto px-6 md:px-12">
            <div class="mb-16 text-center">
              <h2
                class="mb-4 text-center text-2xl text-gray-900 font-bold md:text-3xl"
              >
                Dewan Guru & Staf
              </h2>
            </div>
            <div class="grid gap-12 md:grid-cols-3">
              @foreach ($guru->skip(2) as $item)
              <div class="space-y-4 text-center">
                <img
                  class="w-64 h-64 mx-auto object-cover rounded-full md:w-40 md:h-40 lg:w-64 lg:h-64"
                  {{-- src="{{ asset('storage/' . (empty($guru[2]['image'])?'avatar2.png': $guru[2]['image'] ) ) }}" --}}
                ...
                <div>
                  ...
                  <span class="block text-sm text-gray-500">{{ $item->posisi }}</span>
                </div>
              </div>
              @endforeach
              {{-- <div class="space-y-4 text-center">
                <img
                  class="w-64 h-64 mx-auto object-cover rounded-full md:w-40 md:h-40 lg:w-64 lg:h-64"
                  src="{{ asset('storage/' . (empty($guru[3]['image'])?'avatar2.png': $guru[3]['image'] ) ) }}"
                  alt="woman"
                  loading="lazy"
                  width="1000"
                  height="667"
                />
                <div>
                  <h4 class="text-xl">{{ (empty($guru[3]['name'])?'data belum diisi':$guru[3]['name']) }}</h4>
                  <span class="block text-sm text-gray-500">{{ (empty($guru[3]['posisi'])?'data belum diisi':$guru[3]['posisi']) }}</span>
                </div>
              </div>
              <div class="space-y-4 text-center">
                <img
                  class="w-64 h-64 mx-auto object-cover rounded-full md:w-40 md:h-40 lg:w-64 lg:h-64"
                  src="{{ asset('storage/' . (empty($guru[4]['image'])?'avatar2.png': $guru[4]['image'] ) ) }}"
                  alt="man"
                  loading="lazy"
                  width="1000"
                  height="667"
                />
                <div>
                  <h4 class="text-xl">{{ (empty($guru[4]['name'])?'data belum diisi':$guru[4]['name']) }}</h4>
                  <span class="block text-sm text-gray-500">{{ (empty($guru[4]['posisi'])?'data belum diisi':$guru[4]['posisi']) }}</span>
                </div>
              </div> --}}
            </div>
          </div>
          {{-- <div class="w-full mt-10">
            <div class="grid gap-5 md:grid-cols-2">
              <div class="space-y-4 text-center">
                <img
                  class="w-64 h-64 mx-auto object-cover rounded-full md:w-40 md:h-40 lg:w-64 lg:h-64"
                  src="{{ asset('storage/' . (empty($guru[5]['image'])?'avatar2.png': $guru[5]['image'] ) ) }}"
                  alt="woman"
                  loading="lazy"
                  width="640"
                  height="805"
                />
                <div>
                  <h4 class="text-xl">{{ (empty($guru[5]['name'])?'data belum diisi':$guru[5]['name']) }}</h4>
                  <span class="block text-sm text-gray-500">{{ (empty($guru[5]['posisi'])?'data belum diisi':$guru[5]['posisi']) }}</span>
                </div>
              </div>
              <div class="space-y-4 text-center">
                <img
                  class="w-64 h-64 mx-auto object-cover rounded-full md:w-40 md:h-40 lg:w-64 lg:h-64"
                  src="{{ asset('storage/' . (empty($guru[6]['image'])?'avatar2.png': $guru[6]['image'] ) ) }}"
                  alt="woman"
                  loading="lazy"
                  width="640"
                  height="805"
                />
                <div>
                  <h4 class="text-xl">{{ (empty($guru[6]['name'])?'data belum diisi':$guru[6]['name']) }}</h4>
                  <span class="block text-sm text-gray-500">{{ (empty($guru[6]['posisi'])?'data belum diisi':$guru[6]['posisi']) }}</span>
                </div>
              </div>
            </div>
          </div> --}}
          ...
          <div class="container mx-auto px-6 md:px-12">
            ...
            <div class="grid gap-12 md:grid-cols-3">
              <div class="space-y-4 text-center">
                <img
                  class="w-64 h-64 mx-auto object-cover rounded-full md:w-40 md:h-40 lg:w-64 lg:h-64"
                  src="{{ asset('storage/' . (empty($guru[7]['image'])?'avatar2.png': $guru[7]['image'] ) ) }}"
                  alt="woman"
                  loading="lazy"
                  width="640"
                  height="805"
                />
                <div>
                  <h4 class="text-xl">{{ (empty($guru[7]['name'])?'data belum diisi':$guru[7]['name']) }}</h4>
                  <span class="block text-sm text-gray-500"
                    >{{ (empty($guru[7]['posisi'])?'data belum diisi':$guru[7]['posisi']) }}</span
                  >
                </div>
              </div>
              <div class="space-y-4 text-center">
                <img
                  class="w-64 h-64 mx-auto object-cover rounded-full md:w-40 md:h-40 lg:w-64 lg:h-64"
                  src="{{ asset('storage/' . (empty($guru[8]['image'])?'avatar2.png': $guru[8]['image'] ) ) }}"
                  alt="woman"
                  loading="lazy"
                  width="1000"
                  height="667"
                />
                <div>
                  <h4 class="text-xl">{{ (empty($guru[8]['name'])?'data belum diisi':$guru[8]['name']) }}</h4>
                  <span class="block text-sm text-gray-500">{{ (empty($guru[8]['posisi'])?'data belum diisi':$guru[8]['posisi']) }}</span>
                </div>
              </div>
              <div class="space-y-4 text-center">
                <img
                  class="w-64 h-64 mx-auto object-cover rounded-full md:w-40 md:h-40 lg:w-64 lg:h-64"
                  src="{{ asset('storage/' . (empty($guru[9]['image'])?'avatar2.png': $guru[9]['image'] ) ) }}"
                  alt="man"
                  loading="lazy"
                  width="1000"
                  height="667"
                />
                <div>
                  <h4 class="text-xl">{{ (empty($guru[9]['name'])?'data belum diisi':$guru[9]['name']) }}</h4>
                  <span class="block text-sm text-gray-500">{{ (empty($guru[9]['posisi'])?'data belum diisi':$guru[9]['posisi']) }}</span>
                </div>
              </div>
            </div>
          </div>
