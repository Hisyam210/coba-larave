...
<html lang="en">
  ...
  <body>
   ...
   <!-- Header end -->
    ...
    <section
      id="home"
      class="bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-80 pb-32 pt-5 bg-contain bg-biru md:bg-contain bg-no-repeat lg:bg-auto"
    >
      <div class="container">
        <div class="flex flex-wrap" data-aos="fade-up" data-aos-duration="700">
          <div class="w-full self-center px-4 lg:w-[45%]">
            <img src="aset/imagecontact.png" alt="animasi home" />
          </div>
          <div class="w-full self-end lg:w-[55%]">
            <div class="relative mt-10">
              <div class="max-w-xl mx-auto text-center" data-aos="fade-up">
                <h2
                  class="font-bold font-sans text-white text-3xl mb-4 sm:text-4xl lg:text-5xl"
                >
                  Contact Us
                </h2>
              </div>
                  ...
                  <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-2">
                    <div class="md:col-span-2 lg:col-span-1 my-5">
                      ...
                      <div class="w-full h-full">
                        <!-- graph -->
                        <div
                          class="h-60 shadow-lg bg-kuning hover:scale-105 hover:shadow-2xl ml-5 py-5 px-3 space-y-6 rounded-md transition ease-in-out duration-200"
                        >
                          <!-- text header -->
                          <div>
                            <h2
                              class="font-inter text-2xl text-black text-center mt-4"
                            >
                              Email
                            </h2>
                            <a
                              class="flex flex-wrap justify-center text-xl hover:text-slate-500 mt-5"
                              aria-label="Call"
                              href="mailto:{{ (empty($contac[0]['email'])?'data belum diisi':$contac[0]['email']) }}"
                            >
                              <svg
                                class="w-16 mr-2"
                                xmlns="http://www.w3.org/2000/svg"
                              ...
                              <p class="my-auto text-xl lg:text-base">
                        ...
                        >
                          ...
                          <div>
                            ...
                            <a
                              class="flex flex-wrap justify-center text-xl hover:text-slate-500 mt-5"
                              aria-label="Call"
                              href="tel:{{ (empty($contac[0]['nomor'])?'data belum diisi':$contac[0]['nomor']) }}"
                            >
                              <svg
                                class="w-14 mr-2"
                                xmlns="http://www.w3.org/2000/svg"
                              ...
                              <p class="my-auto text-xl lg:text-base">
                                {{ (empty($contac[0]['nomor'])?'data belum diisi':$contac[0]['nomor']) }}
                              </p>
                            </a>
                          </div>
                          <!-- text header end -->
                    ...
                    <div class="md:col-span-2 lg:col-span-1">
                      <!-- button start -->
                      <div class="w-full h-full lg:ml-40">
                        <!-- graph -->
                        <div
                          class="h-60 shadow-lg bg-kuning hover:scale-105 hover:shadow-2xl ml-5 py-5 px-3 space-y-6 rounded-md transition ease-in-out duration-200"
                        >
                          ...
                          <div>
                            <h2
                              class="font-inter text-2xl text-black text-center"
                            >
                              Address
                            </h2>
                            <a
                              class="flex flex-wrap text-xl justify-center hover:text-slate-500 mt-5"
                              aria-label="Maps"
                              href="http://maps.google.com/?q=Playgroup and Daycare Ananda Mentari"
                            >
                              <svg
                                class="w-14 lg:w-1/4 mr-2"
                                role="img"
                                viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg"
                              >
    ...
    <section>
      <div class="container">
        <div class="my-10 flex flex-wrap ">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3953.323256271224!2d110.39290901459809!3d-7.755498794410372!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a59a6d4a237c7%3A0x78fe581b20f39ef7!2sPlaygroup%20and%20Daycare%20Ananda%20Mentari!5e0!3m2!1sid!2sid!4v1665598082410!5m2!1sid!2sid"
            width="700"
            height="600"
            style="border: 0"
            allowfullscreen=""
          ...
          ></iframe>
          <div class="w-full xl:w-[45%] rounded-tr-lg rounded-br-lg  bg-slate-200">
            <h3 class="ml-10 pt-10 font-bold font-sans text-2xl">Have A Question?</h3>
            <a
              class="flex flex-wrap ml-10 text-[#25D366]  hover:text-slate-400 mt-5"
              target="_blank"
            ...
            >
              <img
              class="w-14 " 
              src="aset/iconWa.png" alt="">
              <p class="font-bold font-sans text-lg my-auto ml-2">Hubungi Admin </p>
            </a>
            <div class="w-full justify-center">
              <div class="relative mt-10">
                <h3 class="ml-10  font-bold font-sans text-2xl">Quick Email</h3>
            
                <form method="post" action="/paud/contact" class="mb-5" enctype="multipart/form-data">
                  @csrf
                  <div class="w-full ml-10 lg:w-2/3 mt-2">
                    <div class="w-full " data-aos="fade-up">
                      <label for="nama" class="w-full flex text-based text-black font-bold"
                        >Nama</label
                      >
                      <input
                        type="text"
                        id="nama"
                        name="nama"
                        class="w-2/3 lg:w-full  bg-white text-dark p-3 rounded-md focus:outline-none focus:ring-ijo focus:ring-1 focus:border-ijo"
                      />
                    </div>
                    <div class="w-full " data-aos="fade-up">
                      <label for="email" class="w-full flex text-based text-black font-bold"
                        >Email</label
                      >
                      <input
                        type="email"
                    ...
                    <div class="w-full " data-aos="fade-up">
                      <label for="pesan" class="w-full flex text-based text-bllack font-bold"
                        >Pesan</label
                      >
                      <textarea
                        type="text"
                        id="pesan"
                        name="pesan"
                        class="w-2/3 lg:w-full h-32  bg-white text-dark p-3 rounded-md focus:outline-none focus:ring-ijo focus:ring-1 focus:border-ijo"
                      >
                      </textarea>
                    </div>
                    <div
                    ...
                    >
                      <button
                        type="submit"
                        class="w-2/3 lg:w-full text-base font-semibold text-white bg-kuning py-3 px-8 mb-5 rounded-lg hover:opacity-80 hover:shadow-lg transition duration-500"
                      >
                        Send
                      </button>
                    </div>
