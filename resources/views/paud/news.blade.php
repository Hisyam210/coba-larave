...
<html lang="en">
    ...
    <div class="container">
      <div class="flex items-center justify-between relative">
        <div class="px-3 xl:ml-32">
          <a href="/paud"
            ><img src="{{ asset('storage/' . 'mainlogo.png' ) }}" class="w-64 block py-0"
          /></a>
        </div>
  ...
  <!-- Header end -->
    ...
    <section id="news" class="bg-slate-50">
      <div class="">
        <div class="w-full text-center font-poppins text-black pt-10">
          <h1
            class="text-3xl font-bold uppercase bg-clip-text text-transparent bg-ijo"
          >
            
            <span
              class="uppercase bg-clip-text text-transparent font-bold bg-kuning"
            >
              {{$blog->title}}</span
            >
          </h1>
          <h2 class="pt-4 text-lg text-gray-800 capitalize">
            <span class="mr-2">penulis :</span>{{$blog->user->name}}
          </h2>
          <h3 class="text-base text-gray-500 capitalize">
            {{$blog->created_at->diffForHumans()}}
          </h3>
          <img
            src="{{ asset('storage/' . (empty($blog['image'])?'jpg1.jpg': $blog['image'] ) ) }}"
            class="w-full md:w-1/2 md:h-1/2 mx-auto pt-5"
            alt="foto pak sandi"
          />
        </div>
        <div
          class="max-w-2xl my-10 mx-auto p-5 font-poppins text-black"
        >
          <p
            class="text-justify first-line:uppercase text-slate-700 first-line:tracking-wider first-letter:text-7xl first-letter:float-left first-letter:mr-3"
          >
          {!! $blog->body !!}
          </p>
        </div>
        <div class="w-full text-center font-poppins text-black pt-10">
          <h3
            class="text-xl font-bold capitalize bg-clip-text text-transparent bg-black"
          >
            other article :
          </h3>

          <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 py-5">
            @foreach ($post as $item)
                
            <div
              class="relative p-1 pb-16 rounded-xl group bg-white bg-opacity-50 shadow-xl hover:scale-105 transition delay-100 hover:rounded-2xl"
            >
              <div class="relative">
                <div
                  aria-hidden="true"
                  class="absolute inset-x-0 bottom-0 h-64 bg-gradient-to-b from-transparent to-yellow-50"
                ></div>
                <img
              ...
              >
                <div
                  aria-hidden="true"
                  class="h-10 w-10 flex border border-ijo rounded-full"
                >
                  <svg
                    aria-hidden="true"
                    width="24"
                    height="24"
                    fill="none"
                    class="my-auto mx-auto flex-none text-ijo"
                  >
                    <path
                ...
                <span class="text-ijo">Read more</span>
              </a>
            </div>
            @endforeach
            {{-- <div
            ...
            >
              <div class="relative">
                ...
                ></div>
                <img
                  src="aset/fotosportday/photo_sport_1.jpg"
                  alt="art cover"
                  loading="lazy"
                  width="1000"
                  height="667"
            ...
            >
              <div class="relative">
                ...
                ></div>
                <img
                  src="aset/outdoor/photo_outdoor_3.jpg"
                  alt="art cover"
                  loading="lazy"
                  width="1000"
                  height="667"
            ...
            >
              <div class="relative">
                ...
                ></div>
                <img
                  src="aset/independenceday/photo_kemerdekaan_2.jpg"
                  alt="art cover"
                  loading="lazy"
                  width="1000"
                  height="667"
                  class="h-64 w-full object-cover rounded-t-lg transition duration-500 group-hover:rounded-t-xl"
                />
              </div>
              <div class="relative space-y-4 -mt-20 p-4">
                <h4 class="text-2xl font-semibold text-yellow-900">
