...
<html lang="en">
  ...
  <body>
           ...
           >
             <ul class="block lg:flex">
               ...
               <li class="group">
                 <a
                   href="/event"
                   class="text-base bg-hijaumuda text-dark py-2 px-3 mx-4 flex group-hover:text-black group-hover:bg-hijautua rounded-md transition delay-50"
                   >Events</a
                 >
               </li>
               <li class="group">
   ...
   <!-- Header end -->
    ...
    <section
      id="event"
      class="w-full bg-cover bg-no-repeat bg-hijautua"
      style="background-image: url(aset/bg-ekskul.png)"
    >
      <div class="py-16 backdrop-blur-sm">
        <div class="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
          <div class="mb-12 space-y-2 text-center font-poppins">
            ...
            <h2
              class="block w-max mx-auto px-3 py-1.5 border text-4xl p-4 font-caveat border-green-200 rounded-full bg-green-100 text-green-600"
            >
              Kegiatan Ananda Mentari
            </h2>
          </div>

          <div class="grid gap-12 lg:grid-cols-2">
            <div
              class="font-poppins p-1 rounded-xl group sm:flex space-x-6 bg-white bg-opacity-80 hover:bg-opacity-100 shadow-xl hover:scale-105 duration-100 delay-100 hover:rounded-2xl"
            >
              <img
                src="{{ asset('storage/' . (empty($blog[0]['image'])?'jpg1.jpg': $blog[0]['image'] ) ) }}"
                alt="foto tamasya"
                loading="lazy"
                width="1000"
                height="667"
              ...
              <div class="sm:w-7/12 pl-0 p-5">
                <div class="space-y-2">
                  <div class="space-y-4">
                    <h3
                      class="text-3xl font-semibold text-slate-700 font-caveat capitalize"
                    >
                      {{ (empty($blog[0]['title'])?'data belum diisi':$blog[0]['title']) }}
                    </h3>
                    <p class="text-gray-600">
                      {{ (empty($blog[0]['excerpt'])?'data belum diisi':$blog[0]['excerpt']) }}
                    </p>
                  </div>
                  <a href="/paud/news/{{ (empty($blog[0]['slug'])?'null':$blog[0]['slug']) }}" class="block w-max text-cyan-600">Read more</a>
                </div>
              </div>
            </div>
            <div
            ...
            >
              <img
                src="{{ asset('storage/' . (empty($blog[1]['image'])?'jpg1.jpg': $blog[1]['image'] ) ) }}"
                alt="foto tamasya"
                loading="lazy"
                width="1000"
                height="667"
                ...
                <div class="space-y-2">
                  <div class="space-y-4">
                    <h3
                      class="text-3xl font-semibold text-slate-700 font-caveat capitalize"
                    >
                    {{ (empty($blog[1]['title'])?'data belum diisi':$blog[1]['title']) }}
                    </h3>
                    <p class="text-gray-600">
                      {{ (empty($blog[1]['excerpt'])?'data belum diisi':$blog[1]['excerpt']) }}
                    </p>
                  </div>
                  <a href="/paud/news/{{ (empty($blog[1]['slug'])?'null':$blog[1]['slug']) }}" class="block w-max text-cyan-600">Read more</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4 py-8">
            @foreach ($blog->skip(2) as $item)                
            <div
              class="relative p-1 pb-16 rounded-xl group bg-white bg-opacity-80 hover:bg-opacity-100 shadow-xl hover:scale-105 transition delay-100 hover:rounded-2xl"
            >
              <div class="relative">
                <div
                  aria-hidden="true"
                ...
                ></div>
                <img
                  src="{{ asset('storage/' . (empty($item['image'])?'jpg1.jpg': $item['image'] ) ) }}"
                  alt="art cover"
                  loading="lazy"
                  width="1000"
                  height="667"
              ...
              <div class="relative space-y-2 p-4">
                <h3
                  class="capitalize text-3xl font-semibold text-slate-800 font-caveat"
                >
                {{ (empty($item['title'])?'data belum diisi':$item['title']) }}
                </h3>
                <p class="text-gray-600 font-poppins text-justify">
                  {{ (empty($item['excerpt'])?'data belum diisi':$item['excerpt']) }}
                </p>
              </div>
              <a
                href="/paud/news/{{ (empty($item['slug'])?'null':$item['slug']) }}"
                class="absolute inset-x-4 bottom-4 flex items-center space-x-2"
              >
                <div
                  aria-hidden="true"
                  class="h-10 w-10 flex border border-cyan-600 rounded-full"
                >
                  <svg
                    aria-hidden="true"
                    width="24"
                    height="24"
                    fill="none"
                    class="my-auto mx-auto flex-none text-cyan-600"
                  >
                    <path
                ...
                <span class="text-cyan-600 text-lg font-bold">Read more</span>
              </a>
            </div>
            @endforeach
            {{-- <div
            ...
            >
              <div class="relative">
                ...
                ></div>
                <img
                  src="aset/teaparty/photo_tea_1.jpg"
                  alt="art cover"
                  loading="lazy"
                  width="1000"
                  height="667"
      ...
      <div class="py-16 bg-gray-50">
        <div class="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
          <div class="mb-12 space-y-2">
            <span
              class="block w-max px-3 py-1.5 border border-green-200 rounded-full bg-green-100 text-green-600"
              >Tips</span
            >
            ...
            <p class="lg:w-6/12">
              Ananda Mentari punya berbagai tips & trick yang sayang dilewatkan.
              Apa aja sih itu ? Mari kita simak !
            </p>
          </div>

          <div class="grid gap-12 md:grid-cols-2">
            <div class="group space-y-4 hover:scale-105 duration-100 delay-100">
              <img
                src="aset/bg-anak-demam.jpg"
                alt="art cover"
                loading="lazy"
                width="1000"
                height="667"
              ...
              />
              <div class="space-y-2">
                <span class="text-cyan-500">Health</span>
                <div class="space-y-4">
                  <h3 class="text-2xl font-semibold text-gray-700">
                    Anak Demam Jangan Dikasih Obat Sirup, Begini Cara
                    Meredakannya
                  </h3>
                  <p class="text-gray-600">
                    Mengingat anjuran Kemenkes untuk tidak memberikan obat-obatan cair atau berbentuk sirup, ada tiga langkah mudah yang dapat dilakukan orangtua agar demam anak mereda.
                  </p>
                </div>
              </div>
            ...
            <div class="group space-y-4 hover:scale-105 duration-100 delay-100">
              ...
              <div class="space-y-2">
                ...
                <div class="space-y-4">
                  ...
                  <p class="text-gray-600">
                    Berikut rekomendasi obat batuk pilek demam alami untuk anak dan bayi yang praktis, rasanya enak, dan aman rekomendasi
