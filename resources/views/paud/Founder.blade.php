...
<html lang="en">
  ...
  <body>
   ...
   <!-- Header end -->
    ...
    <section
      id="home"
      class="h-full lg:h-screen backdrop-blur-xl bg-white/30 bg-cover bg-center bg-no-repeat"
      style="background-image: url(aset/guestspeaker/photo_guest_2.jpg)"
    >
      <div class="w-full h-full backdrop-blur-md py-20 bg-black/50">
        <div class="container">
          <div
          ...
          >
            <div
              class="w-full text-white self-center text-center px-4 lg:w-1/2"
            >
              <h1
                class="text-lg uppercase font-sans md:text-aaaaaxl lg:text-xl"
                data-aos="fade-up"
                data-aos-duration="700"
              >
                founder ananda mentari
              </h1>
              <h1
                class="text-3xl font-bold font-poppins md:text-4xl lg:text-5xl"
                data-aos="fade-up"
                data-aos-duration="700"
              >
              {{ (empty($founder[0]['nama'])?'data belum diisi':$founder[0]['nama']) }}
              </h1>
              <p
                class="text-xl ml-1 my-4 font-poppins leading-relaxed font-light md:text-2xl"
              >
              {!! (empty($founder[0]->body))?'data belum diisi':strip_tags($founder[0]->body) !!}
              </p>
            </div>
            <div class="w-full self-end py-10 lg:w-1/2">
              <div class="relative">
                <img
                  style="max-height: 400px; overflow:hidden"
                  src="{{ asset('storage/' . (empty($founder[0]['image'])?'jpg4.jpg': $founder[0]['image'] ) ) }}"
                  alt="Foto founder"
                  class="w-full h-full mx-auto rounded-lg"
                />
              </div>
            </div>
          </div>
    ...
    <!-- Hero no bg section start -->
    <section id="no_bg" class="pt-10 pb-16 bg-gradient-to-br from-hijaumuda to-[#1FC5A8]">
      <div class="container bg-white/10">
        <div class="flex flex-wrap">
          <div class="flex items-center w-full mb-10">
            <div class="w-[60%] lg:w-1/3 mr-5 flex justify-center items-center">
              <img
                style="max-height: 300px; overflow:hidden"
                src="{{ asset('storage/' . (empty($founder[1]['image'])?'avatar2.png': $founder[1]['image'] ) ) }}"
                alt="icon visi"
                class="w-4/5 h-full"
              />
            </div>
            <div class="w-full font-poppins">
              <h2 class="font-bold uppercase text-3xl pb-2">
                {{ (empty($founder[1]['nama'])?'data belum diisi':$founder[1]['nama']) }}
              </h2>
              <p class="text-xl">
                {!! (empty($founder[1]->body))?'data belum diisi':strip_tags($founder[1]->body) !!}
              </p>
            </div>
          </div>
          <div class="flex items-center w-full mb-10">
            <div class="w-full font-inter mr-5">
              <h2 class="font-bold text-3xl uppercase pb-2">
                {{ (empty($founder[2]['nama'])?'data belum diisi':$founder[2]['nama']) }}
              </h2>
              <p class="text-xl font-poppins">
                {!! (empty($founder[2]->body))?'data belum diisi':strip_tags($founder[2]->body) !!}
              </p>
            </div>
            <div class="w-[60%] lg:w-1/3 flex justify-center items-center">
              <img
                style="max-height: 300px; overflow:hidden"
                src="{{ asset('storage/' . (empty($founder[2]['image'])?'avatar2.png': $founder[2]['image'] ) ) }}"
                alt="icon misi"
                class="w-full h-full"
              />
            </div>
      ...
      <div class="w-full absolute mt-10 h-10 bg-cover bg-no-repeat rounded-t-full"
      style="background-image:url(aset/bg-batik.jpeg)"
      >
  
      </div>
    </section>
    <!-- Hero left right section end -->
    <section id="with_bg" class="w-full mt-10 bg-no-repeat bg-cover"
      ...
      <div class="flex flex-wrap">
        <div class="flex items-center w-full mb-10">
          <div class="w-[60%] lg:w-1/3 mr-5 flex justify-center items-center">
            <img
              style="max-height: 300px; overflow:hidden"
              src="{{ asset('storage/' . (empty($founder[3]['image'])?'avatar2.png': $founder[3]['image'] ) ) }}"
              alt="icon visi"
              class="w-4/5 h-full"
            />
          </div>
          <div class="w-full font-inter">
            <h2 class="font-bold uppercase text-3xl pb-2">
              {{ (empty($founder[3]['nama'])?'data belum diisi':$founder[3]['nama']) }}
            </h2>
            <p class="text-xl font-poppins">
              {!! (empty($founder[3]->body))?'data belum diisi':strip_tags($founder[3]->body) !!}
            </p>
          </div>
        </div>
        <div class="flex items-center w-full mb-10">
          <div class="w-full font-inter mr-5">
            <h2 class="font-bold text-3xl uppercase pb-2">
              {{ (empty($founder[4]['nama'])?'data belum diisi':$founder[4]['nama']) }}
            </h2>
            <p class="text-xl font-poppins">
              {!! (empty($founder[4]->body))?'data belum diisi':strip_tags($founder[4]->body) !!}
            </p>
          </div>
          <div class="w-[60%] lg:w-1/3 flex justify-center items-center">
            <img
              style="max-height: 300px; overflow:hidden"
              src="{{ asset('storage/' . (empty($founder[4]['image'])?'avatar2.png': $founder[4]['image'] ) ) }}"
              alt="icon misi"
              class="w-full h-full"
            />
          </div>
    ...
    <section id="with_bg" class="w-full pt-10 bg-gradient-to-br from-[#72B2e4] to-[#92E1E2]"
    >
      ...
      <div class="flex flex-wrap">
        <div class="flex items-center w-full mb-10">
          <div class="w-[60%] lg:w-1/3 mr-5 flex justify-center items-center">
            <img
            style="max-height: 300px; overflow:hidden"
              src="{{ asset('storage/' . (empty($founder[5]['image'])?'avatar2.png': $founder[5]['image'] ) ) }}"
              alt="icon visi"
              class="w-4/5 h-full"
            />
          </div>
          <div class="w-full font-inter">
            <h2 class="font-bold uppercase text-3xl pb-2">
              {{ (empty($founder[5]['nama'])?'data belum diisi':$founder[5]['nama']) }}
            </h2>
            <p class="text-xl font-poppins">
              {!! (empty($founder[5]->body))?'data belum diisi':strip_tags($founder[5]->body) !!}
            </p>
          </div>
        </div>
        <div class="flex items-center w-full mb-10">
          <div class="w-full font-inter mr-5">
            <h2 class="font-bold text-3xl uppercase pb-2">
              {{ (empty($founder[6]['nama'])?'data belum diisi':$founder[6]['nama']) }}
            </h2>
            <p class="text-xl font-poppins">
              {!! (empty($founder[6]->body))?'data belum diisi':strip_tags($founder[6]->body) !!}
            </p>
          </div>
          <div class="w-[60%] lg:w-1/3 flex justify-center items-center">
            <img
            style="max-height: 300px; overflow:hidden"
              src="{{ asset('storage/' . (empty($founder[6]['image'])?'avatar2.png': $founder[6]['image'] ) ) }}"
              alt="icon misi"
              class="w-full h-full"
            />
          </div>
        ...
        <div class="flex items-center w-full mb-10">
          <div class="w-[60%] lg:w-1/3 mr-5 flex justify-center items-center">
            <img 
            style="max-height: 300px; overflow:hidden"
              src="{{ asset('storage/' . (empty($founder[7]['image'])?'avatar2.png': $founder[7]['image'] ) ) }}"
              alt="icon visi"
              class="w-4/5 h-full"
            />
          </div>
          <div class="w-full font-inter">
            <h2 class="font-bold uppercase text-3xl pb-2">
              {{ (empty($founder[7]['nama'])?'data belum diisi':$founder[7]['nama']) }}
            </h2>
            <p class="text-xl  font-poppins">
              {!! (empty($founder[7]->body))?'data belum diisi':strip_tags($founder[7]->body) !!}
            </p>
          </div>
        </div>
      </div>
