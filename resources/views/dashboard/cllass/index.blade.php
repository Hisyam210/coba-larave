...
@section('container')
    ...
    <div class="table-responsive col-lg-5">
        <a href="/dashboard/cllass/create" class="btn btn-primary mb-3">New </a>
      <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td> {{$clas->class}} </td>
              <td>
                  <a href="/dashboard/cllass/{{$clas->id}}/edit" class="badge bg-warning">
                  <span data-feather="edit" class="align-text-bottom"></span>
                  </a>
                  <form action="/dashboard/cllass/{{$clas->id}}" method="post" class="d-inline">
                    @method('delete')
                    @csrf
